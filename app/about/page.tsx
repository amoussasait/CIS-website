...
import { Target, Eye, Heart, BookOpen, Shield, Users2, FileText, Download } from "lucide-react"
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <Card className="border-2 border-primary/20 hover:shadow-lg transition-shadow">
              <CardContent className="p-8">
                ...
                <Button asChild className="w-full" size="lg">
                  <a href="/documents/CISS-Bylaws-Nov-2025.pdf" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center gap-2">
            ...
            <Card className="border-2 border-primary/20 hover:shadow-lg transition-shadow">
              <CardContent className="p-8">
                ...
                <Button asChild className="w-full" size="lg">
                  <a href="/documents/CISS-Special-Resolutions-Oct-2025.pdf" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center gap-2">
                    <Download className="w-4 h-4" />
